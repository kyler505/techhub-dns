            ...
            <div className="mx-auto max-w-4xl space-y-6">
                <div className="space-y-1 text-foreground">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Complete the checklist for <span className="font-semibold text-gray-900">{order.inflow_order_id}</span> before submission.
                    </p>
                    {lastSavedAt && (
                ...
                <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-lg">
                    <div className="space-y-6 p-6">
                        ...
                        <div className="rounded-2xl border border-border/60 bg-muted/40 p-4 text-sm text-foreground">
                            Technician recorded as <span className="font-semibold text-blue-900">{user?.display_name || user?.email || "Current User"}</span> on submission.
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-gray-500">Automatic signature recorded on submit.</p>
                        </div>
