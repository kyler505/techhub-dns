...
export default function OrderDetailPage() {
    ...
    return (
        <div className="container mx-auto py-6 space-y-4">
            <button
                onClick={() => navigate(-1)}
                className="inline-flex items-center rounded-md border border-maroon-900/20 bg-background px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-maroon-50"
            >
                ← Back
            </button>
